...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item $(\overline C + \overline M)(\overline N + \overline A + Z + C)$ Resolution: $\overline M + \overline A + Z+ \overline N$
        \item $(\overline C + \overline M)(C+D)$ Resolution: $\overline M + D$
        \item $(\overline P + \overline N + \overline Z)(\overline N + \overline A + Z +C)$ Resolution: $\overline P + \overline N + \overline A + C$
        \item $(\overline A + C + D)(\overline N + \overline D + \overline P)$ Resolution: $\overline A + C + \overline N + \overline P$
        \item $(\overline A + C + D) \overline C$ Resolution: $\overline A + D$
        \item $M(\overline M + \overline A + D)$ Resolution: $\overline A + D$
        \item $A(\overline N + \overline A + Z + C)$ Resolution: $\overline N +Z +C$
        \item $A(\overline A + \overline M + D) $ Resolution: $\overline M + D$
        \item $P(\overline N + \overline D + \overline P)$ Resolution: $\overline N + \overline D$
        \item $(\overline N + \overline D + \overline P)(\overline M + \overline A + D)$ Resolution: $\overline N + \overline M + \overline P + \overline A$
        \item $(\overline N + \overline D + \overline P)(C+D)$ Resolution: $ \overline N + \overline P + C$
        \item $(\overline N + \overline A + Z + C)(\overline C)$ Resolution: $\overline N + \overline A + Z$
        \item $(\overline N + \overline A + Z + C)(\overline N + \overline Z)$ Resolution: $ \overline N + \overline A + C$
        \item $(\overline C)(C+D)$ Resolution: $D$
    \end{enumerate}
    \item new = $\{(\overline N + Z + \overline M + \overline A),(\overline N + Z + C),(\overline N + \overline D),(\overline M + D),(\overline P + \overline N + \overline A + C),\}$
\end{enumerate}
